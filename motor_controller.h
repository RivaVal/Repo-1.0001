...
#include <Arduino.h>
// В motor_control.h используется deprecated API
#include <driver/mcpwm.h> // ❌ УСТАРЕЛО - БУДЕТ УДАЛЕНО В БУДУЩИХ ВЕРСИЯХ

// Должно быть:
#include <driver/mcpwm_prelude.h> // ✅ СОВРЕМЕННЫЙ API
